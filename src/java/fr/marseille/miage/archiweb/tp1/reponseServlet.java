 ...
 * @author l11626937
 */
@WebServlet(name = "reponseServlet", urlPatterns = {"/reponseServlet"})
public class reponseServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        responseBean.setName((String)request.getAttribute("name"));
        responseBean.setAuteurs((String[]) request.getParameterValues("auteurs"));
